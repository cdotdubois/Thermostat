...
long LastTemperatureData1; //Variable to store the previous temperature reading
...
//char BelowTemp[44] = "The temperature is below 30 degrees Celsius.";
//char AboveTemp[44] = "The temperature is above 30 degrees Celsius.";
int StatusofTemp;
/***********************************************************************************************************************/
...
void ReadSensorDataAndNotify(void)
{
    ...
    if(TemperatureNotificationEnabled && (Temperature != LastTemperatureData1))
    {
        ...
        LastTemperatureData1 = Temperature; //Store the current temperature data for reference
