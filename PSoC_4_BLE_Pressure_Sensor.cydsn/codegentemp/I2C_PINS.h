...
/* Unconfigured pins */
#define I2C_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define I2C_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define I2C_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define I2C_RX_WAKE_SDA_MOSI_PIN (0u == I2C_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define I2C_RX_SDA_MOSI_PIN     (0u == I2C_REMOVE_RX_SDA_MOSI_PIN)
#define I2C_TX_SCL_MISO_PIN     (0u == I2C_REMOVE_TX_SCL_MISO_PIN)
...
#if (I2C_RX_WAKE_SDA_MOSI_PIN)
    #include "I2C_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (I2C_RX_SDA_MOSI) */

#if (I2C_RX_SDA_MOSI_PIN)
    #include "I2C_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (I2C_RX_SDA_MOSI) */

#if (I2C_TX_SCL_MISO_PIN)
    #include "I2C_uart_tx_i2c_scl_spi_miso.h"
#endif /* (I2C_TX_SCL_MISO) */
...
#if (I2C_RX_SDA_MOSI_PIN)
    #define I2C_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define I2C_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define I2C_RX_SDA_MOSI_HSIOM_MASK      (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define I2C_RX_SDA_MOSI_HSIOM_POS       (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define I2C_RX_SDA_MOSI_HSIOM_SEL_GPIO  (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define I2C_RX_SDA_MOSI_HSIOM_SEL_I2C   (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define I2C_RX_SDA_MOSI_HSIOM_SEL_SPI   (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define I2C_RX_SDA_MOSI_HSIOM_SEL_UART  (I2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (I2C_RX_WAKE_SDA_MOSI_PIN)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_MASK      (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_POS       (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (I2C_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) I2C_INTCFG_TYPE_MASK << \
                                                                           I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins I2C_RX_SDA_MOSI_PIN or I2C_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (I2C_RX_SDA_MOSI_PIN) */

#if (I2C_TX_SCL_MISO_PIN)
    #define I2C_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define I2C_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define I2C_TX_SCL_MISO_HSIOM_MASK      (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define I2C_TX_SCL_MISO_HSIOM_POS       (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define I2C_TX_SCL_MISO_HSIOM_SEL_GPIO  (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define I2C_TX_SCL_MISO_HSIOM_SEL_I2C   (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define I2C_TX_SCL_MISO_HSIOM_SEL_SPI   (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define I2C_TX_SCL_MISO_HSIOM_SEL_UART  (I2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (I2C_TX_SCL_MISO_PIN) */
...
/* Pins settings index. */
#define I2C_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define I2C_RX_SDA_MOSI_PIN_INDEX       (0u)
#define I2C_TX_SCL_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define I2C_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << I2C_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define I2C_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << I2C_RX_SDA_MOSI_PIN_INDEX)
#define I2C_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << I2C_TX_SCL_MISO_PIN_INDEX)
...
#if (I2C_TX_SCL_MISO_PIN)
    #define I2C_CHECK_TX_SCL_MISO_PIN_USED \
                (I2C_PIN_DM_ALG_HIZ != \
                    I2C_GET_P4_PIN_DM(I2C_uart_tx_i2c_scl_spi_miso_PC, \
                                                   I2C_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (I2C_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define I2C_SET_I2C_SCL_DR(val) \
                            I2C_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define I2C_SET_I2C_SCL_HSIOM_SEL(sel) \
                    I2C_SET_HSIOM_SEL(I2C_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   I2C_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   I2C_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define I2C_WAIT_SCL_SET_HIGH  (0u == I2C_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (I2C_RX_SDA_MOSI_PIN)
    #define I2C_SET_I2C_SCL_DR(val) \
                            I2C_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define I2C_SET_I2C_SCL_HSIOM_SEL(sel) \
                            I2C_SET_HSIOM_SEL(I2C_RX_SDA_MOSI_HSIOM_REG,  \
                                                           I2C_RX_SDA_MOSI_HSIOM_MASK, \
                                                           I2C_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define I2C_WAIT_SCL_SET_HIGH  (0u == I2C_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (I2C_TX_SCL_MISO_PIN)
    #define I2C_WAIT_SDA_SET_HIGH  (0u == I2C_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define I2C_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) I2C_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define I2C_REMOVE_MOSI_SCL_RX_WAKE_PIN    I2C_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define I2C_REMOVE_MOSI_SCL_RX_PIN         I2C_REMOVE_RX_SDA_MOSI_PIN
#define I2C_REMOVE_MISO_SDA_TX_PIN         I2C_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define I2C_MOSI_SCL_RX_WAKE_PIN   I2C_RX_WAKE_SDA_MOSI_PIN
#define I2C_MOSI_SCL_RX_PIN        I2C_RX_SDA_MOSI_PIN
#define I2C_MISO_SDA_TX_PIN        I2C_TX_SCL_MISO_PIN
#ifndef I2C_SCLK_PIN
...
#define I2C_SS0_PIN                I2C_RTS_SS0_PIN
    ...
    #define I2C_MOSI_SCL_RX_WAKE_HSIOM_REG     I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_WAKE_HSIOM_PTR     I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_WAKE_HSIOM_MASK    I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_WAKE_HSIOM_POS     I2C_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define I2C_MOSI_SCL_RX_WAKE_INTCFG_REG    I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_WAKE_INTCFG_PTR    I2C_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define I2C_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  I2C_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (I2C_RX_WAKE_SDA_MOSI_PIN) */

#if (I2C_MOSI_SCL_RX_PIN)
    #define I2C_MOSI_SCL_RX_HSIOM_REG      I2C_RX_SDA_MOSI_HSIOM_REG
    #define I2C_MOSI_SCL_RX_HSIOM_PTR      I2C_RX_SDA_MOSI_HSIOM_PTR
    #define I2C_MOSI_SCL_RX_HSIOM_MASK     I2C_RX_SDA_MOSI_HSIOM_MASK
    #define I2C_MOSI_SCL_RX_HSIOM_POS      I2C_RX_SDA_MOSI_HSIOM_POS
#endif /* (I2C_MOSI_SCL_RX_PIN) */

#if (I2C_MISO_SDA_TX_PIN)
    #define I2C_MISO_SDA_TX_HSIOM_REG      I2C_TX_SCL_MISO_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_PTR      I2C_TX_SCL_MISO_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_MASK     I2C_TX_SCL_MISO_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_POS      I2C_TX_SCL_MISO_HSIOM_REG
...
#define I2C_MOSI_SCL_RX_WAKE_PIN_INDEX I2C_RX_WAKE_SDA_MOSI_PIN_INDEX
#define I2C_MOSI_SCL_RX_PIN_INDEX      I2C_RX_SDA_MOSI_PIN_INDEX
#define I2C_MISO_SDA_TX_PIN_INDEX      I2C_TX_SCL_MISO_PIN_INDEX
...
#define I2C_MOSI_SCL_RX_WAKE_PIN_MASK I2C_RX_WAKE_SDA_MOSI_PIN_MASK
#define I2C_MOSI_SCL_RX_PIN_MASK      I2C_RX_SDA_MOSI_PIN_MASK
#define I2C_MISO_SDA_TX_PIN_MASK      I2C_TX_SCL_MISO_PIN_MASK
