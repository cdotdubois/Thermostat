    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x59u] = {
    /* Device Name */
    (uint8)'B', (uint8)'M', (uint8)'P', (uint8)'1', (uint8)'8', (uint8)'0', (uint8)' ', (uint8)'P', (uint8)'r',
    (uint8)'e', (uint8)'s', (uint8)'s', (uint8)'u', (uint8)'r', (uint8)'e', (uint8)' ', (uint8)'S', (uint8)'e',
    (uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r',
    ...
    (uint8)'r', (uint8)'e', (uint8)' ', (uint8)'(', (uint8)'0', (uint8)'.', (uint8)'1', (uint8)'Â', (uint8)'°',
    (uint8)'C', (uint8)')',
    ...
    /* Characteristic User Description */
    (uint8)'P', (uint8)'r', (uint8)'e', (uint8)'s', (uint8)'s', (uint8)'u', (uint8)'r', (uint8)'e', (uint8)' ',
    (uint8)'(', (uint8)'0', (uint8)'.', (uint8)'0', (uint8)'1', (uint8)'h', (uint8)'P', (uint8)'a', (uint8)')',

    /* Altitude */
    0x00u,

    /* Characteristic User Description */
    (uint8)'A', (uint8)'l', (uint8)'t', (uint8)'i', (uint8)'t', (uint8)'u', (uint8)'d', (uint8)'e', (uint8)' ',
    (uint8)'(', (uint8)'m', (uint8)')',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* BMP180 */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xF0u, 0xF0u, 0x00u, 0x00u },
    /* Temperature */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xF1u, 0xF0u, 0x00u, 0x00u },
    /* Pressure */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xF2u, 0xF0u, 0x00u, 0x00u },
    /* Altitude */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xF3u, 0xF0u, 0x00u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0004u, (void *)&cyBle_attValues[32] }, /* Service Changed */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* BMP180 UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Temperature UUID */
    { 0x0001u, (void *)&cyBle_attValues[36] }, /* Temperature */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0014u, (void *)&cyBle_attValues[37] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Pressure UUID */
    { 0x0001u, (void *)&cyBle_attValues[57] }, /* Pressure */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x0012u, (void *)&cyBle_attValues[58] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* Altitude UUID */
    { 0x0001u, (void *)&cyBle_attValues[76] }, /* Altitude */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
    { 0x000Cu, (void *)&cyBle_attValues[77] }, /* Characteristic User Description */
};

const CYBLE_GATTS_DB_T cyBle_gattDB[0x18u] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0xF0F1u /* Temperature                         */, 0x09100000u /* ntf    */, 0x0010u, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0010u, {{0x0014u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x0014u, {{0x0010u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0012u, 0xF0F2u /* Pressure                            */, 0x09100000u /* ntf    */, 0x0014u, {{0x0001u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0013u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0014u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0014u, {{0x0012u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0xF0F3u /* Altitude                            */, 0x09100000u /* ntf    */, 0x0018u, {{0x0001u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0017u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0018u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0018u, {{0x000Cu, (void *)&cyBle_attValuesLen[17]}} },
};
