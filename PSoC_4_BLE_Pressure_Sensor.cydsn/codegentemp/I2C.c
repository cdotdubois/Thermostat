...
static void I2C_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2C_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            I2C_RX_SDA_MOSI_HSIOM_SEL_GPIO,
            I2C_TX_SCL_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (I2C_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_RX_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_OD_LO;
        #elif (I2C_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2C_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2C_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_OD_LO;
        #else
        #endif /* (I2C_RX_SDA_MOSI_PIN) */
        
        #if (I2C_TX_SCL_MISO_PIN)
            hsiomSel[I2C_TX_SCL_MISO_PIN_INDEX] = I2C_TX_SCL_MISO_HSIOM_SEL_I2C;
            pinsDm  [I2C_TX_SCL_MISO_PIN_INDEX] = I2C_PIN_DM_OD_LO;
        ...
        {
        #if (I2C_RX_SDA_MOSI_PIN)
            hsiomSel[I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_RX_SDA_MOSI_HSIOM_SEL_SPI;
        #elif (I2C_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2C_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (I2C_RX_SDA_MOSI_PIN) */
        
        #if (I2C_TX_SCL_MISO_PIN)
            hsiomSel[I2C_TX_SCL_MISO_PIN_INDEX] = I2C_TX_SCL_MISO_HSIOM_SEL_SPI;
        #endif /* (I2C_TX_SCL_MISO_PIN) */
            ...
            {
                /* Slave */
                pinsDm[I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
                pinsDm[I2C_TX_SCL_MISO_PIN_INDEX] = I2C_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= I2C_TX_SCL_MISO_PIN_MASK;
            #endif /* (I2C_TX_SCL_MISO_PIN) */
            }
            else 
            {
                /* (Master) */
                pinsDm[I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_STRONG;
                pinsDm[I2C_TX_SCL_MISO_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
            ...
            #if (I2C_RX_SDA_MOSI_PIN)
                pinsInBuf |= I2C_RX_SDA_MOSI_PIN_MASK;
            #elif (I2C_RX_WAKE_SDA_MOSI_PIN)
                pinsInBuf |= I2C_RX_WAKE_SDA_MOSI_PIN_MASK;
            #else
            #endif /* (I2C_RX_SDA_MOSI_PIN) */
        ...
        else /* UART */
        {
            if (I2C_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (I2C_TX_SCL_MISO_PIN)
                hsiomSel[I2C_TX_SCL_MISO_PIN_INDEX] = I2C_TX_SCL_MISO_HSIOM_SEL_UART;
                pinsDm  [I2C_TX_SCL_MISO_PIN_INDEX] = I2C_PIN_DM_OD_LO;
            #endif /* (I2C_TX_SCL_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (I2C_RX_SDA_MOSI_PIN)
                    hsiomSel[I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_RX_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2C_RX_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
                #elif (I2C_RX_WAKE_SDA_MOSI_PIN)
                    hsiomSel[I2C_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2C_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
                #else
                #endif /* (I2C_RX_SDA_MOSI_PIN) */
                }
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        I2C_SET_HSIOM_SEL(I2C_RX_SDA_MOSI_HSIOM_REG,
                                       ...
                                       I2C_RX_SDA_MOSI_HSIOM_POS,
                                        hsiomSel[I2C_RX_SDA_MOSI_PIN_INDEX]);

        I2C_uart_rx_i2c_sda_spi_mosi_SetDriveMode((uint8) pinsDm[I2C_RX_SDA_MOSI_PIN_INDEX]);

        #if (!I2C_CY_SCBIP_V1)
            I2C_SET_INP_DIS(I2C_uart_rx_i2c_sda_spi_mosi_INP_DIS,
                                         I2C_uart_rx_i2c_sda_spi_mosi_MASK,
                                         (0u != (pinsInBuf & I2C_RX_SDA_MOSI_PIN_MASK)));
        #endif /* (!I2C_CY_SCBIP_V1) */
        ...
        I2C_SET_HSIOM_SEL(I2C_RX_WAKE_SDA_MOSI_HSIOM_REG,
                                       ...
                                       hsiomSel[I2C_RX_WAKE_SDA_MOSI_PIN_INDEX]);

        I2C_uart_rx_wake_i2c_sda_spi_mosi_SetDriveMode((uint8)
                                                               pinsDm[I2C_RX_WAKE_SDA_MOSI_PIN_INDEX]);

        I2C_SET_INP_DIS(I2C_uart_rx_wake_i2c_sda_spi_mosi_INP_DIS,
                                     I2C_uart_rx_wake_i2c_sda_spi_mosi_MASK,
                                     (0u != (pinsInBuf & I2C_RX_WAKE_SDA_MOSI_PIN_MASK)));

         /* Set interrupt on falling edge */
        I2C_SET_INCFG_TYPE(I2C_RX_WAKE_SDA_MOSI_INTCFG_REG,
                                        I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK,
    ...
    #if (I2C_TX_SCL_MISO_PIN)
        I2C_SET_HSIOM_SEL(I2C_TX_SCL_MISO_HSIOM_REG,
                                       I2C_TX_SCL_MISO_HSIOM_MASK,
                                       I2C_TX_SCL_MISO_HSIOM_POS,
                                        hsiomSel[I2C_TX_SCL_MISO_PIN_INDEX]);

        I2C_uart_tx_i2c_scl_spi_miso_SetDriveMode((uint8) pinsDm[I2C_TX_SCL_MISO_PIN_INDEX]);

    #if (!I2C_CY_SCBIP_V1)
        I2C_SET_INP_DIS(I2C_uart_tx_i2c_scl_spi_miso_INP_DIS,
                                     I2C_uart_tx_i2c_scl_spi_miso_MASK,
                                    (0u != (pinsInBuf & I2C_TX_SCL_MISO_PIN_MASK)));
    #endif /* (!I2C_CY_SCBIP_V1) */
    #endif /* (I2C_RX_SDA_MOSI_PIN) */
