...
extern long LastTemperatureData1; //Previous temperature reading is stored in this variable
    ...
    switch(Event)
	{
        ...
        ***********************************************************/
        ...
        case CYBLE_EVT_GATT_DISCONNECT_IND: //This event is received when device is disconnected
            ...
            LastTemperatureData1 = ZERO; //Clear last stored temperature notification data
